  ...
  render() {
    ...
    return users.length > 0
      ? (
        ...
        <table style={{border: "3px solid black",padding: "20px 16px", width: "500px"}}>
          <caption style={{border: "3px solid black",padding: "20px 16px"}}><h1><b>Transaction sorted by occurence</b></h1>
