...
export default class Transtotal extends React.Component {
...
async componentDidMount() {
  ...
  const response = await fetch("http://localhost:1300/transaction/totalcost")
  ...
  render() {
    ...
    return users.length > 0
      ? (
        ...
        <table style={{border: "3px solid black", width: "700px",margin: "100px"}}>
          <caption style={{border: "3px solid black",padding: "20px 16px"}}><h1><b>Transaction sorted according to billing amount</b></h1>
